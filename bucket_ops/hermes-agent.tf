...
module "hermes-agent" {
  ...
  images = {
    hermes-agent = {
      ...
      tag        = "v2026.9.24@sha256:fca358f12efd65bfaaca05884166f15c0e2788375ca30d77061ac1ebc96452b7" # renovate: datasource=docker depName=docker.io/nousresearch/hermes-agent
    }
    hermes-webui = {

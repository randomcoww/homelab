...
module "hermes-agent" {
  ...
  images = {
    hermes-agent = {
      ...
      tag        = "v2026.8.19.1787574254@sha256:74221444e3b734c90bd0f8b52f955a44041b37898f586d4e404ea375cadc8087" # renovate: datasource=docker depName=reg.cluster.internal/randomcoww/hermes-mnemosyne
    }
    hermes-webui = {

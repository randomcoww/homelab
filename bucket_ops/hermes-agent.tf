...
module "hermes-agent" {
  ...
  images = {
    hermes-agent = {
      ...
      tag        = "v2026.8.19.1787811146@sha256:5ddfa0ec95929aea9646295284d1170b0c19c6bb5d48564fa0a544253786fd9f" # renovate: datasource=docker depName=zot.cluster.internal/randomcoww/hermes-mnemosyne
    }
    hermes-webui = {

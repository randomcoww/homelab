...
module "llama-cpp" {
  ...
  images = {
    llama-swap = {
      ...
      tag        = "unified-vulkan-2026-08-10.1786365672@sha256:5076cdc97bdcfb288a343648f46f4d0115e9681fa51b79815d6a0ef8eb341453" # renovate: datasource=docker depName=reg.cluster.internal/randomcoww/llama-swap-ffmpeg
    }
  }
  models = merge([
    for _, image in [

            ...
            extensions = [
              {
                ...
                image = {
                  reference = join(":", [
                    ...
                    "0.8.6-18-trixie@sha256:0a621c4d083550ac10862bdd0a6907119844e20b4796f06ff1ebae4e1f96f319", # renovate: datasource=docker depName=ghcr.io/cloudnative-pg/pgvector
                  ])
                }
              },
            ]

            ...
            extensions = [
              {
                ...
                image = {
                  reference = join(":", [
                    ...
                    "0.8.6-18-trixie@sha256:ac868a69dcd7fb75d7c52bb43ec83094bab3c8f13a0145b8e34d0ad0bea913cc", # renovate: datasource=docker depName=ghcr.io/cloudnative-pg/pgvector
                  ])
                }
              },
            ]

            ...
            extensions = [
              {
                ...
                image = {
                  reference = join(":", [
                    ...
                    "0.8.6-18-trixie@sha256:d518480f927c790aefb12b3af8d3641f0ef06284262dc94a9f89cc89b4b86fb5", # renovate: datasource=docker depName=ghcr.io/cloudnative-pg/pgvector
                  ])
                }
              },
            ]

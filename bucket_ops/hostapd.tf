...
module "hostapd-qrcode" {
  ...
  images = {
    qrcode = {
      ...
      tag        = "v1.1790012936@sha256:3b6263d93d095a79cce9562628bf1cb35358e4f3a0b45c565a66495dc17d3417" # renovate: datasource=docker depName=zot.cluster.internal/randomcoww/qrcode-resource
    }
  }

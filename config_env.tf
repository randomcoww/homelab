locals {
  ...
  container_images = {
    ...
    ipxe                  = "ghcr.io/randomcoww/ipxe:v20251119.015046@sha256:40229090859a08bb80611b061eb8709c91fd66f8be39d7b41f93b349bb181d67"
    ...
    github_actions_runner = "ghcr.io/actions/actions-runner:2.330.0@sha256:25e5339f41c8511899dff6d9d1ee3d29d0aaca085f24b967f486e153e4368cc6"
    # tier 3
    ...
    llama_cpp        = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:eda4140da396e008e2963daa241a77bc46fbdee82555919ff4e7e742d3a42417"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:804eb0e37fa051b78b2830ea3d9ae4b9e2a1460eb80f9235c98c3f1a1409d93c"

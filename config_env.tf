locals {
  ...
  container_images = {
    ...
    searxng           = "ghcr.io/searxng/searxng:latest@sha256:a1a04679fe6a4fa6bfe9efb82adfbe7bee4eaef8d77b2392562ca5bfe032c4be"
    ...
    navidrome         = "ghcr.io/navidrome/navidrome:0.63.1@sha256:7c43af9f651654e97278be871705aae85a4ee0fa4b310337989699a8ada9b3ed"

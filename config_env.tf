locals {
  ...
  container_images = {
    ...
    device_plugin         = "ghcr.io/squat/generic-device-plugin:latest@sha256:efa50af6e8919b71694909f763e06aa80f37dbc605bbbe4018aa0252a75c24a4"
    ...
    llama_cpp_vulkan = "ghcr.io/ggml-org/llama.cpp:server-vulkan-b8157@sha256:c3cea2b8e2a990a1cfea2159e8ae5f2f31c23867d00e290b0f828c7afbb20931"
    ...
    llama_swap       = "ghcr.io/mostlygeek/llama-swap:vulkan-non-root@sha256:b3ba096099742d05771a40dc31c2e6d2f66d00e3ba59ac1a2995800a580c5d24"
    ...
    valkey           = "ghcr.io/valkey-io/valkey:9.0.3-alpine@sha256:ad09f25978db13ed3ed7c635a0e43118568deca056ed8f7a5020f40632e2923e"
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:2c86f95c22dde03f5354a81b027ec882830748c5fe6454f03c7ec8fc384e54ea"

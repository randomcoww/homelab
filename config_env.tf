locals {
  ...
  container_images = {
    ...
    llama_cpp_vulkan = "ghcr.io/mostlygeek/llama-swap:vulkan-non-root@sha256:6e74955bad8bc1ffe4f6b0a7dcceb14d58fe42eb87abb8aa3da2293221ae7a1b"
    llama_cpp_rocm   = "ghcr.io/mostlygeek/llama-swap:rocm-non-root@sha256:816ae62a1f286661fb308e3d8b6c1e71c7530dedea289ac3e2e04ec9b50dfdf0"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:aace39e738c8022456a9f64aa8289e347833bb9e1f29cd248a22cc7ca7a6f5a3"
  ...
  host_images = {
    for name, tag in {
      # these fields are updated by renovate - don't use var substitutions
      default = "fedora-coreos-43.20260301.20" # renovate: randomcoww/fedora-coreos-config-custom
    } :
    name => {

locals {
  ...
  container_images = {
    ...
    # Helm
    kea                = "ghcr.io/randomcoww/kea:v20250323.0334"
    ...
    kube_proxy         = "ghcr.io/randomcoww/kube-proxy:v20250316.0258"
    litestream         = "ghcr.io/randomcoww/litestream:v20250318.0805"
    tailscale          = "ghcr.io/randomcoww/tailscale-nft:v20250316.0255"
    code_server        = "ghcr.io/randomcoww/code-server:v20250316.0302"
    lldap              = "ghcr.io/lldap/lldap:2025-03-07-alpine-rootless"
    keydb              = "docker.io/eqalpha/keydb:alpine_x86_64_v6.3.4"
    clickhouse         = "docker.io/clickhouse/clickhouse-server:25.3.1.2703-alpine"
    qrcode_generator   = "ghcr.io/randomcoww/qrcode-generator:v20250210.0031"
    rclone             = "docker.io/rclone/rclone:1.69.1"
    s3fs               = "ghcr.io/randomcoww/s3fs:v20250317.1014"
    mountpoint         = "ghcr.io/randomcoww/mountpoint-s3:v20250317.1014"
    ...
    stork_agent        = "ghcr.io/randomcoww/stork-agent:v20250316.0324"
    vaultwarden        = "docker.io/vaultwarden/server:1.33.2-alpine"
    llama_cpp          = "ghcr.io/ggml-org/llama.cpp:server-cuda"
  }

  pxeboot_images = {
    coreos = "fedora-coreos-41.20250322.09" # randomcoww/fedora-coreos-config-custom
  }

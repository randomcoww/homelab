locals {
  ...
  container_images = {
    ...
    mountpoint              = "ghcr.io/randomcoww/mountpoint-s3:v1.19.0.20250821.0353"
    ...
    searxng                 = "docker.io/searxng/searxng:2025.8.20-6b57705"
  ...
  pxeboot_images = {
    latest = "fedora-coreos-42.20250818.01" # randomcoww/fedora-coreos-config
  }

locals {
  ...
  container_images = {
    ...
    nginx       = "docker.io/nginxinc/nginx-unprivileged:1.29.1-alpine@sha256:e46fe28ba3a42f62daaec8baf4f3b0ee63f82b679b71335292784e95675c7185"
    # tier 3
    ...
    llama_cpp             = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:8d27bfb9fd2dfd85b47b6e9e745c5fdb98ebd54acfc83bfcf441d36635112876"
    ...
    searxng               = "ghcr.io/searxng/searxng:latest@sha256:7c0fd2e9d41ac5cb66d27e5703f5aaa3f7a2e5b09a4d0d5ce34151ab0e9a3054"

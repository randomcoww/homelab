locals {
  ...
  container_images = {
    ...
    # tier 2
    kea           = "reg.cluster.internal/randomcoww/kea:v3.1.9.1780341257@sha256:b506615f288bd2443d9d0f6cc512431dffe5d49f78645aa512f5a0df635d57ba"
    ipxe          = "reg.cluster.internal/randomcoww/ipxe:v2.0.0.1780341547@sha256:e16c7b04321106f3ecd796459a204286609f227ca37325f1061c9c01ef59c78c"
    ...
    # tier 3
    mountpoint       = "reg.cluster.internal/randomcoww/mountpoint-s3:v1.22.3.1780341735@sha256:351482683e45d0e375c0fa704276613e67ad425f3fb4410867f1a04041e16dfe"
    hostapd          = "reg.cluster.internal/randomcoww/hostapd:v2.11.1780341270@sha256:1c8ed53d6b2923a03b03b6cdd7fc9d4b3692898d9fe251dddf4d10102d49ed60"
    tailscale        = "ghcr.io/tailscale/tailscale:v1.98.4@sha256:25cde9ad76020b0e29229136d0c38b5962e9a0e1774ffac9b0df68e4a37d6cf0"
    qrcode_generator = "reg.cluster.internal/randomcoww/qrcode-resource:v1780341527@sha256:fb94024b5c95e2a3f34f356b41c70aba26271099ffcc93f6c44fbcdf09453ac8"
    llama_cpp_vulkan = "ghcr.io/mostlygeek/llama-swap:unified-vulkan@sha256:0fbfe13fb2d4b975a03b396c8f85423e25bbb46ab59ab8c02d1ce37ab9a6c6c1"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:1081d08bdcd6126533de497ee597f64de94064339e7bc03bc046352adfe320e6"
    ...
    sunshine_desktop = "reg.cluster.internal/randomcoww/sunshine-desktop:v2026.531.163415.1780341337@sha256:bb24024c8b291ef5753f18debb23700abdd301f489c26594d9239017d0b3b79f"
    ...
    searxng_mcp      = "docker.io/isokoliuk/mcp-searxng:1.1.1@sha256:833b13fc386a8742b8dbc168e443fed3f224ef07b6a19b50b15d6ad7781d47e7"
  ...
  host_images = {
    for name, tag in {
      # these fields are updated by renovate - don't use var substitutions
      default = "44.20260530.20.1.1780252332" # renovate: datasource=github-tags depName=randomcoww/fedora-coreos-config-custom
    } :
    name => {

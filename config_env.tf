locals {
  ...
  container_images = {
    ...
    llama_cpp             = "registry.default/randomcoww/llama-cpp-server-cuda:v20250920.2130"
    ...
    code_server           = "registry.default/randomcoww/code-server:v1.103.1.20250920.1040"
    ...
    nvidia_driver         = "registry.default/randomcoww/nvidia-driver-container:v580.82.09.20250919.0058-fedora42"

locals {
  ...
  container_images = {
    ...
    nginx              = "docker.io/nginxinc/nginx-unprivileged:1.31.2-alpine@sha256:6320020c7da8714feab524e02c08c5a1958675c4e68700e93a2fd8970b065786"
    # tier 2
    ...
    searxng           = "ghcr.io/searxng/searxng:latest@sha256:af9aec5c8fe88767106e8043004a1232d43cabde22869e6355f3a63d26e41351"

locals {
  ...
  container_images = {
    ...
    sunshine_desktop        = "ghcr.io/randomcoww/sunshine-desktop:v2025.609.163957.20250610.2026"
    nvidia_driver           = "ghcr.io/randomcoww/nvidia-driver-container:v575.57.08-fedora42"

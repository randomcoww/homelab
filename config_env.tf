locals {
  ...
  container_images = {
    # Igntion
    kube_apiserver          = "ghcr.io/randomcoww/kubernetes:v1.32.3.20250404.0808"
    kube_controller_manager = "ghcr.io/randomcoww/kubernetes:v1.32.3.20250404.0808"
    kube_scheduler          = "ghcr.io/randomcoww/kubernetes:v1.32.3.20250404.0808"
    etcd_wrapper            = "ghcr.io/randomcoww/etcd-wrapper:v0.4.0"
    etcd                    = "gcr.io/etcd-development/etcd:v3.5.21"

    # Helm
    kea                = "ghcr.io/randomcoww/kea:v2.7.7.20250404.2112"
    matchbox           = "quay.io/poseidon/matchbox:v0.11.0"
    ipxe               = "ghcr.io/randomcoww/ipxe:v20250404.1014"
    ipxe_tftp          = "ghcr.io/randomcoww/ipxe:v20250404.1017-tftp"
    hostapd            = "ghcr.io/randomcoww/hostapd-noscan:v2.11.20250404.0845"
    ...
    kube_proxy         = "ghcr.io/randomcoww/kubernetes:v1.32.3.20250404.0808"
    ...
    mountpoint         = "ghcr.io/randomcoww/mountpoint-s3:v1.16.1.20250404.2122"
    ...
    stork_agent        = "ghcr.io/randomcoww/stork-agent:v20250401.2122"

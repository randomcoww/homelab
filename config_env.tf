locals {
  ...
  container_images = {
    kube_apiserver          = "ghcr.io/randomcoww/kubernetes:v1.33.1.20250601.2313"
    kube_controller_manager = "ghcr.io/randomcoww/kubernetes:v1.33.1.20250601.2313"
    kube_scheduler          = "ghcr.io/randomcoww/kubernetes:v1.33.1.20250601.2313"
    kube_proxy              = "ghcr.io/randomcoww/kubernetes:v1.33.1.20250601.2313"
    ...
    kea                     = "ghcr.io/randomcoww/kea:v2.7.7.20250501.2313"
    matchbox                = "quay.io/poseidon/matchbox:v0.11.0"
    ipxe                    = "ghcr.io/randomcoww/ipxe:v20250501.2122"
    ...
    clickhouse              = "docker.io/clickhouse/clickhouse-server:25.5.1.2782-alpine"
  ...
  pxeboot_images = {
    latest = "fedora-coreos-42.20250507.00" # randomcoww/fedora-coreos-config-custom

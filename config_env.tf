locals {
  ...
  container_images = {
    ...
    etcd_wrapper            = "ghcr.io/randomcoww/etcd-wrapper:v0.4.8"
    etcd                    = "gcr.io/etcd-development/etcd:v3.6.5"
    # tier 1
    kube_proxy         = "ghcr.io/randomcoww/kube-proxy:v1.34.1.20250925.0435"
    ...
    # tier 2
    kea         = "ghcr.io/randomcoww/kea:v3.1.0.20250925.0441"
    stork_agent = "ghcr.io/randomcoww/stork-agent:v2.3.0.20250925.0438"
    ipxe        = "ghcr.io/randomcoww/ipxe:v1.20250925.0434"
    mountpoint  = "ghcr.io/randomcoww/mountpoint-s3:v1.20.0.20250924.2226"
    matchbox    = "quay.io/poseidon/matchbox:v0.11.0"
    nginx       = "docker.io/nginxinc/nginx-unprivileged:1.29.1-alpine"
    # tier 3
    hostapd               = "registry.default/randomcoww/hostapd-noscan:v2.11.20250925.0439"
    tailscale             = "registry.default/randomcoww/tailscale-nft:v1.20250925.0437"
    qrcode_generator      = "registry.default/randomcoww/qrcode-resource:v1.20250925.0438"
    ...
    searxng               = "docker.io/searxng/searxng:latest@sha256:d3704a384057ed95e8bf61556277af356d18f809b9f2350f9b99ecb2da75d427"
  ...
  # these fields are updated by renovate - don't use var substitutions
  pxeboot_images = {
    coreos = "fedora-coreos-42.20250923.07" # randomcoww/fedora-coreos-config
  }

locals {
  ...
  container_images = {
    ...
    # Helm
    kea                = "ghcr.io/randomcoww/kea:v20250216.0327"
    ...
    kube_proxy         = "ghcr.io/randomcoww/kube-proxy:v20250216.0251"
    litestream         = "docker.io/litestream/litestream:0.3.13"
    tailscale          = "ghcr.io/randomcoww/tailscale-nft:v20250216.0246"
    code_server        = "ghcr.io/randomcoww/code-server:v20250216.0255"
    ...
    mountpoint         = "ghcr.io/randomcoww/mountpoint-s3:v20250216.0328"
    s3fs               = "ghcr.io/randomcoww/s3fs:v20250216.0316"
    audioserve         = "docker.io/izderadicka/audioserve:latest"
    syncthing          = "docker.io/syncthing/syncthing:1.29.2"
    kube_vip           = "ghcr.io/kube-vip/kube-vip:v0.8.9"
    sunshine_desktop   = "ghcr.io/randomcoww/sunshine-desktop:v20250216.0324"
  ...
  pxeboot_images = {
    coreos = "fedora-coreos-20250210.2043" # randomcoww/fedora-coreos-config-custom
  }
  ...
  kubernetes_services = {
    ...
    name => merge(e, {
      ...
      endpoints = try([
        ...
        "${e.name}-${i}.${e.headless}.${e.namespace}"
      ], [])
    })
  }

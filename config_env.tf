locals {
  ...
  container_images = {
    ...
    device_plugin         = "ghcr.io/squat/generic-device-plugin:latest@sha256:d64b1c851b534de348bcd3189555a22d3966e6592fc79d2a78abfff4f6c1a2e1"
    ...
    llama_cpp        = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:bf1442d82648491bf09a56837a40d21704fb140b39e38d00bc55a25788bb28ea"

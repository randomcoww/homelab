locals {
  ...
  container_images = {
    ...
    nginx       = "docker.io/nginxinc/nginx-unprivileged:1.29.1-alpine@sha256:46d9e0e89e4b8925a14df6aa6a5bdb64ab102a7ecc87a4bf02f4d100168ccf30"
    # tier 3
    ...
    llama_cpp             = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:85cb915ce381d69a0b9992f3d6619d3430a126a944e360423801e231a39ff8d1"

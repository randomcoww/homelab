locals {
  ...
  container_images = {
    ...
    code_server        = "ghcr.io/randomcoww/code-server:v20250126.2-amd64"
    ...
    sunshine_desktop   = "ghcr.io/randomcoww/sunshine-desktop:v20250127.2"
    nvidia_driver      = "ghcr.io/randomcoww/nvidia-driver-container:565.77-f41-amd64"
  ...
  pxeboot_images = {
    coreos = "fedora-coreos-41.20250125.0"
  }

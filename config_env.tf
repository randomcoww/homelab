locals {
  ...
  container_images = {
    ...
    llama_cpp        = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:b295a1c6fb17fe0b78b08fedcc2596f21691dfbafc7aeceda9fb41b470fd557f"
  ...
  host_images = {
    for name, tag in {
      # these fields are updated by renovate - don't use var substitutions
      amdcompat = "fedora-coreos-43.20260104.04" # renovate: randomcoww/fedora-coreos-config-custom
      default   = "fedora-coreos-43.20251230.10"
    } :
    name => {

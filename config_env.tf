locals {
  ...
  container_images = {
    ...
    etcd_wrapper            = "ghcr.io/randomcoww/etcd-wrapper:v0.3.8"
    ...
    clickhouse         = "docker.io/clickhouse/clickhouse-server:25.1.3.23-alpine"
    ...
    sunshine_desktop   = "ghcr.io/randomcoww/sunshine-desktop:v20250209.2222"

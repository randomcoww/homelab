locals {
  ...
  container_images = {
    ...
    # tier 1
    kube_proxy         = "ghcr.io/randomcoww/kube-proxy:v1.34.1.20250925.2045"
    ...
    # tier 2
    kea         = "ghcr.io/randomcoww/kea:v3.1.0.20250925.2047"
    stork_agent = "ghcr.io/randomcoww/stork-agent:v2.3.0.20250925.2047"
    ipxe        = "ghcr.io/randomcoww/ipxe:v1.20250925.2049"
    ...
    tailscale             = "registry.default/randomcoww/tailscale-nft:v1.20250925.2046"
    ...
    juicefs               = "registry.default/randomcoww/juicefs:v1.3.0.20250925.2046"

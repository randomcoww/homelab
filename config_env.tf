locals {
  ...
  container_images = {
    ...
    nginx              = "docker.io/nginxinc/nginx-unprivileged:1.29.2-alpine@sha256:fb089229c0b27470aef1384985c4f073c19f6e1529a9cfc9676cf7d9869a36f4"
    # tier 2
    ...
    device_plugin         = "ghcr.io/squat/generic-device-plugin:latest@sha256:f4eeaae71c6cd7b4d3950f8f0c46a68da2e0880403adf15dcf6f02cd8d097681"
    ...
    llama_cpp        = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:11b2504d6da51cceeefef61225027996f5e2aeec6d41bac0677f1ff4f8d31972"

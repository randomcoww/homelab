locals {
  ...
  container_images = {
    ...
    nvidia_driver    = "reg.cluster.internal/randomcoww/nvidia-driver-container:v580.105.08@sha256:f7e33ee7ebd6a91d0a9c5bf66080c80c6235003fa647f51571766d35ab06181f"

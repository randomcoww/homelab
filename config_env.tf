locals {
  ...
  container_images = {
    ...
    # tier 2
    kea         = "ghcr.io/randomcoww/kea:v3.1.0.20250926.2052"
    stork_agent = "ghcr.io/randomcoww/stork-agent:v2.3.0.20250926.2053"
    ipxe        = "ghcr.io/randomcoww/ipxe:v1.20250926.2052"
    ...
    # tier 3
    hostapd               = "registry.default/randomcoww/hostapd-noscan:v2.11.20250926.2051"
    tailscale             = "registry.default/randomcoww/tailscale-nft:v1.20250926.2051"
    qrcode_generator      = "registry.default/randomcoww/qrcode-resource:v1.20250926.2053"

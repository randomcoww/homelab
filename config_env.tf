locals {
  ...
  container_images = {
    ...
    # tier 1
    kube_proxy         = "ghcr.io/randomcoww/kubernetes-kube-proxy:v1.34.1.20250923.2006"
    ...
    stork_agent = "ghcr.io/randomcoww/stork-agent:v2.3.0.20250922.0128"
    ...
    llama_cpp             = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:2f92f1407f9397f8a2846f718bb68c6bf2040ae195d936b3044be374dcee31aa"
    ...
    code_server           = "registry.default/randomcoww/code-server:v1.103.1.20250923.2121"

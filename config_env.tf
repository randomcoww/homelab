locals {
  ...
  container_images = {
    ...
    minio              = "cgr.dev/chainguard/minio:latest@sha256:e0f7133335e73ceec23c21f796ffec217e5f6e445a837b7abf1910383171e206"
    ...
    device_plugin = "ghcr.io/squat/generic-device-plugin:latest@sha256:c4e3a24a5f20449e027b9de2c3cee790169ab42220818315f5f8ee9830788981"
    ...
    # tier 3
    mountpoint       = "reg.cluster.internal/randomcoww/mountpoint-s3:v1.22.2.1775487427@sha256:735e889368d3815e6ebaf7ccaadc4d0c02cb71ecbf73cb19d697ea17c9dd2f3e"
    hostapd          = "reg.cluster.internal/randomcoww/hostapd:v2.11.1775486354@sha256:dd76c932b41e58a68004ac61aac15e0bae8798bea7847f3ed888d49109ad2c2c"
    tailscale        = "ghcr.io/tailscale/tailscale:v1.96.5@sha256:dbeff02d2337344b351afac203427218c4d0a06c43fc10a865184063498472a6"
    qrcode_generator = "reg.cluster.internal/randomcoww/qrcode-resource:v1775486609@sha256:e94aceb581b4ecbd7477b99be249ecf6c8231e1dec62b00b5d5a364ddb9cff29"
    llama_cpp_vulkan = "ghcr.io/mostlygeek/llama-swap:vulkan@sha256:cb9412c85956df76532621389b4f8cbdb6030fe56a55ec5350ec3ab6dfac8ee2"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:6a89a150d0163877caab1982b7a20d0a03fd4b39401a0d3f26f61ad205949442"
    ...
    authelia         = "ghcr.io/authelia/authelia:4.39.17@sha256:4f80931cb4180a83b3504962cce1efb3092364387658f1d28ca48584028e382a"
    ...
    sunshine_desktop = "reg.cluster.internal/randomcoww/sunshine-desktop:v2026.408.194927.1775696432@sha256:9f15b15cfab825435c3dfdb6ffb6bb87bfadf681f67892194a3115e984e57ad4"
    kubernetes_mcp   = "ghcr.io/containers/kubernetes-mcp-server:latest@sha256:d330b0848c90dad3069b01921471a87b0b6306d4beedceedeb5cc579d3c8fae2"
    ...
    stump            = "docker.io/aaronleopold/stump:nightly@sha256:98832d479022139e6ab279593b4c01be3b61b7112fab10ddf5c51e92564560cd"

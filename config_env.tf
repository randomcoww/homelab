locals {
  ...
  container_images = {
    ...
    device_plugin         = "ghcr.io/squat/generic-device-plugin:latest@sha256:45abfa9c45aee2d8d9cc1f3d4587c4cf382b36d17b9d937e43d0c07126243037"
    ...
    llama_cpp        = "ghcr.io/mostlygeek/llama-swap:cuda@sha256:2f4585a82a9224a99a2ecd2ad82bc97094e11da38bbaab494c6eb1948523dc87"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:8d98d5c1b678714c3b20dacfab5ea5e3b67f79e50df6d5dbc92ed4f0a964ccbd"

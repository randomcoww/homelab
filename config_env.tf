locals {
  ...
  container_images = {
    ...
    # Helm
    kea                = "ghcr.io/randomcoww/kea:v20250330.0501"
    ...
    litestream         = "ghcr.io/randomcoww/litestream:v20250330.0337"
    kube_proxy         = "ghcr.io/randomcoww/kube-proxy:v20250330.0304"
    tailscale          = "ghcr.io/randomcoww/tailscale-nft:v20250330.0302"
    lldap              = "ghcr.io/lldap/lldap:2025-03-30-alpine-rootless"
    ...
    s3fs               = "ghcr.io/randomcoww/s3fs:v20250330.0330"
    mountpoint         = "ghcr.io/randomcoww/mountpoint-s3:v20250330.0339"
    audioserve         = "docker.io/izderadicka/audioserve:latest"
    kube_vip           = "ghcr.io/kube-vip/kube-vip:v0.8.9"
    sunshine_desktop   = "ghcr.io/randomcoww/sunshine-desktop:v20250330.0337"
    nvidia_driver      = "ghcr.io/randomcoww/nvidia-driver-container:v570.86.15-fedora41"
    steamcmd           = "ghcr.io/randomcoww/steamcmd:v20250330.0428"
    kvm_device_plugin  = "ghcr.io/randomcoww/kvm-device-plugin:v20250211.0006"
    stork_agent        = "ghcr.io/randomcoww/stork-agent:v20250330.0331"
    vaultwarden        = "docker.io/vaultwarden/server:1.33.2-alpine"
    llama_cpp          = "ghcr.io/ggml-org/llama.cpp:server-cuda"
  }

  pxeboot_images = {
    coreos = "fedora-coreos-41.20250327.01" # randomcoww/fedora-coreos-config-custom
  }

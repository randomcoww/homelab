locals {
  ...
  container_images = {
    ...
    tftpd              = "ghcr.io/randomcoww/tftpd-ipxe:v20250126.1"
    ...
    code_server        = "ghcr.io/randomcoww/code-server:v20250209.2137"
    ...
    mountpoint         = "ghcr.io/randomcoww/mountpoint-s3:v20250209.2156"
    ...
    nvidia_driver      = "ghcr.io/randomcoww/nvidia-driver-container:570.86.15-fedora41"
  ...
  pxeboot_images = {
    coreos = "fedora-coreos-20250207.1" # randomcoww/fedora-coreos-config-custom
  }

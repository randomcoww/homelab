locals {
  ...
  container_images = {
    ...
    minio              = "cgr.dev/chainguard/minio:latest@sha256:b6d84d8d23965914937b172bce5089fb4bdba0b7ebcb96aeca14695c9ae52318"
    ...
    llama_cpp_vulkan = "ghcr.io/mostlygeek/llama-swap:vulkan-non-root@sha256:4f98da330a4e19b9a397af9e32f97609e8e826269a0a2e91ac247ecded877e48"
    llama_cpp_rocm   = "ghcr.io/mostlygeek/llama-swap:rocm-non-root@sha256:e67b66ba27f36a006f4d085bcde535e66cac07741e1276633187120521067ebc"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:dc9c7aae0b77f8cd819dd8c7e6d489eab456000838e062c399f2bf37d230500e"

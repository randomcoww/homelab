locals {
  ...
  container_images = {
    kube_apiserver          = "ghcr.io/randomcoww/kubernetes:v1.33.4.20250816.2150"
    kube_controller_manager = "ghcr.io/randomcoww/kubernetes:v1.33.4.20250816.2150"
    kube_scheduler          = "ghcr.io/randomcoww/kubernetes:v1.33.4.20250816.2150"
    kube_proxy              = "ghcr.io/randomcoww/kubernetes:v1.33.4.20250816.2126-kube-proxy"
    ...
    kea                     = "ghcr.io/randomcoww/kea:v3.1.0.20250802.2321"
    matchbox                = "quay.io/poseidon/matchbox:v0.11.0"
    ipxe                    = "ghcr.io/randomcoww/ipxe:v20250816.2216"
    ipxe_tftp               = "ghcr.io/randomcoww/ipxe:v20250816.2213-tftp"
  ...
  pxeboot_images = {
    latest = "fedora-coreos-42.20250807.05" # randomcoww/fedora-coreos-config
  }

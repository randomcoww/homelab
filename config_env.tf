locals {
  ...
  container_images = {
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:8efc0bf2159969100964cd8e3102f6bbff0814fab3dad7b800c89e4c1074587b"
  ...
  host_images = {
    for name, tag in {
      # these fields are updated by renovate - don't use var substitutions
      default = "44.20260503.20.1.1777962512" # renovate: datasource=github-tags depName=randomcoww/fedora-coreos-config-custom
    } :
    name => {

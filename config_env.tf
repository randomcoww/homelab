locals {
  ...
  container_images = {
    ...
    etcd_wrapper            = "ghcr.io/randomcoww/etcd-wrapper:v0.4.7"
    etcd                    = "gcr.io/etcd-development/etcd:v3.6.5"
    # tier 1
    kube_proxy         = "ghcr.io/randomcoww/kube-proxy:v1.34.1.20250924.2148"
    ...
    ipxe        = "ghcr.io/randomcoww/ipxe:v20250923.2337"
    ...
    juicefs               = "registry.default/randomcoww/juicefs:v1.3.0.20250924.2148"
    code_server           = "registry.default/randomcoww/code-server:v1.103.1.20250924.2147"

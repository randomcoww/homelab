locals {
  ...
  container_images = {
    ...
    nginx              = "docker.io/nginxinc/nginx-unprivileged:1.29.2-alpine@sha256:031d8c8ab79d2d171a2a383aa50a06f527791c05ba1aeae9ca05d7b9779caf8e"
    # tier 2
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:5cf43eea89b334f0b34ec03eef03a432e1734dbc13e980878ea1442c50391c7e"

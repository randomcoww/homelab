locals {
  ...
  container_images = {
    ...
    llama_cpp        = "ghcr.io/mostlygeek/llama-swap:vulkan-non-root@sha256:0641d0d0dba6fdfbb6c5d8513ee999e7e0dcdd62d5bfa95a68366f7037fa0fd0"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:d7fa033c5d77a9d2d8a114fa21a62754f095aaf252dfb41bbe3f7b3591669eaf"
  ...
  host_images = {
    for name, tag in {
      # these fields are updated by renovate - don't use var substitutions
      default = "fedora-coreos-43.20260120.23" # renovate: randomcoww/fedora-coreos-config-custom
    } :
    name => {

locals {
  ...
  container_images = {
    ...
    llama_cpp_vulkan = "ghcr.io/ggml-org/llama.cpp:server-vulkan-b7880@sha256:57dcf3fc25edcfe5faea8869bd232997ee540770938f85a05de4139a1e89d323"
    ...
    searxng          = "ghcr.io/searxng/searxng:latest@sha256:0355eac00e7ec52decf6586f03209a9aeb8c63a1ecbf200835fdb3e2247ced02"

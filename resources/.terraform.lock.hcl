...
provider "github.com/hashicorp/kubernetes-alpha" {
  version = "0.2.1"
  hashes = [
    "h1:Nt8xDRxyD8yRZJ6jP2XH6wln6EAp/GEP8EErPrachXw=",
  ]
}
...
provider "github.com/poseidon/matchbox" {
  version = "0.4.1"
  hashes = [
    "h1:2UHIsrHT7jbCgMyY87Mo/PziJwlrVlBmW8cuF5pm2rM=",
  ]
}
...
provider "github.com/randomcoww/libvirt" {
  version = "0.1.9"
  hashes = [
    "h1:/wmoZFW83yek753rw2VU3g8aq9unaRiPx/YvxuD1n9I=",
  ]
}
...
provider "github.com/randomcoww/ssh" {
  version = "0.1.2"
  hashes = [
    "h1:ksoodSFu1I9E/ch/BjKalhFGGuTGCO02vmk3Z48mNbU=",
  ]
}

...
provider "minio" {
  ...
  minio_user     = data.terraform_remote_state.host.outputs.minio.access_key_id
  minio_password = data.terraform_remote_state.host.outputs.minio.secret_access_key
  minio_ssl      = true

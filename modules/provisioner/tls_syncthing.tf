...
resource "tls_locally_signed_cert" "syncthing" {
  ...
  ca_key_algorithm   = "${tls_private_key.syncthing_ca.algorithm}"
  ca_private_key_pem = "${tls_private_key.syncthing_ca.private_key_pem}"
  ca_cert_pem        = "${tls_self_signed_cert.syncthing_ca.cert_pem}"
